export const COUNTRIES = [
  ...
  { name: 'British Virgin Islands', code: '+1-284', iso: 'VG', flag: '🇻🇬' },
  ...
  { name: 'Falkland Islands', code: '+500', iso: 'FK', flag: '🇫🇰' },
  { name: 'Faroe Islands', code: '+298', iso: 'FO', flag: '🇫🇴' },
  { name: 'Fiji', code: '+679', iso: 'FJ', flag: '🇫🇯' },
  { name: 'Finland', code: '+358', iso: 'FI', flag: '🇫🇮' },
  { name: 'France', code: '+33', iso: 'FR', flag: '🇫🇷' },
  { name: 'French Guiana', code: '+594', iso: 'GF', flag: '🇬🇫' },
  { name: 'French Polynesia', code: '+689', iso: 'PF', flag: '🇵🇫' },
  ...
  { name: 'Greenland', code: '+299', iso: 'GL', flag: '🇬🇱' },
  { name: 'Grenada', code: '+1-473', iso: 'GD', flag: '🇬🇩' },
  { name: 'Guadeloupe', code: '+590', iso: 'GP', flag: '🇬🇵' },
  { name: 'Guam', code: '+1-671', iso: 'GU', flag: '🇬🇺' },
  { name: 'Guatemala', code: '+502', iso: 'GT', flag: '🇬🇹' },
  { name: 'Guernsey', code: '+44-1481', iso: 'GG', flag: '🇬🇬' },
  ...
  { name: 'Isle of Man', code: '+44-1624', iso: 'IM', flag: '🇮🇲' },
  ...
  { name: 'Jersey', code: '+44-1534', iso: 'JE', flag: '🇯🇪' },
  ...
  { name: 'Kosovo', code: '+383', iso: 'XK', flag: '🇽🇰' },
  ...
  { name: 'Montserrat', code: '+1-664', iso: 'MS', flag: '🇲🇸' },
  ...
  { name: 'Netherlands Antilles', code: '+599', iso: 'AN', flag: '🇳🇦' },
  { name: 'New Caledonia', code: '+687', iso: 'NC', flag: '🇳🇨' },
  ...
  { name: 'Niue', code: '+683', iso: 'NU', flag: '🇳🇺' },
  { name: 'North Korea', code: '+850', iso: 'KP', flag: '🇰🇵' },
  { name: 'Northern Mariana Islands', code: '+1-670', iso: 'MP', flag: '🇲🇵' },
  ...
  { name: 'Puerto Rico', code: '+1-787', iso: 'PR', flag: '🇵🇷' },
  { name: 'Qatar', code: '+974', iso: 'QA', flag: '🇶🇦' },
  { name: 'Republic of the Congo', code: '+242', iso: 'CG', flag: '🇨🇬' },
  { name: 'Reunion', code: '+262', iso: 'RE', flag: '🇷🇪' },
  { name: 'Romania', code: '+40', iso: 'RO', flag: '🇷🇴' },
  { name: 'Russia', code: '+7', iso: 'RU', flag: '🇷🇺' },
  { name: 'Rwanda', code: '+250', iso: 'RW', flag: '🇷🇼' },
  { name: 'Saint Barthelemy', code: '+590', iso: 'BL', flag: '🇧🇱' },
  { name: 'Saint Helena', code: '+290', iso: 'SH', flag: '🇸🇭' },
  { name: 'Saint Kitts and Nevis', code: '+1-869', iso: 'KN', flag: '🇰🇳' },
  { name: 'Saint Lucia', code: '+1-758', iso: 'LC', flag: '🇱🇨' },
  { name: 'Saint Martin', code: '+590', iso: 'MF', flag: '🇲🇫' },
  { name: 'Saint Pierre and Miquelon', code: '+508', iso: 'PM', flag: '🇵🇲' },
  { name: 'Saint Vincent and the Grenadines', code: '+1-784', iso: 'VC', flag: '🇻🇨' },
  ...
  { name: 'Sint Maarten', code: '+1-721', iso: 'SX', flag: '🇸🇽' },
  ...
  { name: 'Svalbard and Jan Mayen', code: '+47', iso: 'SJ', flag: '🇸🇯' },
  ...
  { name: 'Tokelau', code: '+690', iso: 'TK', flag: '🇹🇰' },
  ...
  { name: 'Turks and Caicos Islands', code: '+1-649', iso: 'TC', flag: '🇹🇨' },
  { name: 'Tuvalu', code: '+688', iso: 'TV', flag: '🇹🇻' },
  { name: 'U.S. Virgin Islands', code: '+1-340', iso: 'VI', flag: '🇻🇮' },
  ...
  { name: 'Vatican', code: '+379', iso: 'VA', flag: '🇻🇦' },
  { name: 'Venezuela', code: '+58', iso: 'VE', flag: '🇻🇪' },
  { name: 'Vietnam', code: '+84', iso: 'VN', flag: '🇻🇳' },
  { name: 'Wallis and Futuna', code: '+681', iso: 'WF', flag: '🇼🇫' },
  { name: 'Western Sahara', code: '+212', iso: 'EH', flag: '🇪🇭' },
  { name: 'Yemen', code: '+967', iso: 'YE', flag: '🇾🇪' },
  { name: 'Zambia', code: '+260', iso: 'ZM', flag: '🇿🇲' },
  { name: 'Zimbabwe', code: '+263', iso: 'ZW', flag: '🇿🇼' },
];

export const RECENTS_KEY = 'fw-recents';
export const SAVED_KEY = 'fw-saved';
export const THEME_KEY = 'fw-theme';
export const INSTALL_KEY = 'fw-install-dismissed';
